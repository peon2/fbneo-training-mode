...
RESOURCEPATH = "resources/" -- PNGs are assumed for images
BASIC_ICONS_RESOURCEPATH = RESOURCEPATH.."icons/"
REPLAY_ICONS_RESOURCEPATH = RESOURCEPATH.."replay/"
SCROLLING_INPUT_RESOURCEPATH = RESOURCEPATH.."scrolling-input/"
STICK_ICONS_RESOURCEPATH = RESOURCEPATH.."stick/"
