PECHAN_CONFIG = {
    GAMES = {
        ["kof98"] = {
            ...
            has_wakeup = true,
            has_recovery = true,
            has_hit_reversal = true,
            has_dizzy = true,
            has_character_selection = true,
            has_cpu_settings = true,
            has_dummy_settings = true,
            has_setups_configuration = true,
            has_trials = true,
            has_ex = true,
            has_modes = true,
        ...
        ["kof2001"] = {
            ...
            offsets = {
                ...
                player2_stored_index = 0x270C,
                striker1_stored_index = 0x26E7,
                p1_striker2_stored_index = 0x26E8, -- P1 S2
                p1_striker3_stored_index = 0x26E9, -- P1 S3
                striker2_stored_index = 0x270D,    -- P2 S1 (Standard P2 Striker)
                p2_striker2_stored_index = 0x270E, -- P2 S2
                p2_striker3_stored_index = 0x270F, -- P2 S3
                striker_count_address = 0x01E3,    -- Relative offset for striker stock (1082E3 for P1)
                obj_ptr_list = 0x10B094 + 0xE90,
                game_phase = 0x10B094,
                level_address = 0x10FD8E,
                stage_address = 0x10A7EA,
    ...
    get_current_game = function()
        ...
        return PECHAN_CONFIG.GAMES[rname] or PECHAN_CONFIG.GAMES["kof98"]
    end,
...
PECHAN_CONFIG.UI.CURRENT_PLAYER2 = PECHAN_CONFIG.get_current_game().characters[28]
