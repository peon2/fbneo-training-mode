...
--
	...
	--			func = [[function()
	--					PECHAN_CONFIG.MOVES_VAR_NAMES["]]..type..[["]["]]..index..[["] = PECHAN_CONFIG.MOVES_VAR_NAMES["]]..type..[["]["]]..index..[["]+ 1
	--					if PECHAN_CONFIG.MOVES_VAR_NAMES["]]..type..[["]["]]..index..[["] > 1 then
	--						PECHAN_CONFIG.MOVES_VAR_NAMES["]]..type..[["]["]]..index..[["]  = 0
	--					end
	--					PECHAN_CONFIG["]]..type..[["].reversal_moves = getCurrentReversalMoves("]]..type..[[")
	--			end]],
	--			autofunc = [[function(this)
	--				
	--				if (PECHAN_CONFIG.MOVES_VAR_NAMES["]]..type..[["]["]]..index..[["] == PECHAN_CONFIG.REVERSAL_MOVES.OPTIONS.OFF) then
	--					this.text = "]]..index..[[" .. ": Off" 
	--				elseif (PECHAN_CONFIG.MOVES_VAR_NAMES["]]..type..[["]["]]..index..[["] == PECHAN_CONFIG.REVERSAL_MOVES.OPTIONS.ON) then
	--					this.text = "]]..index..[[" .. ": ON" 
	--				end
	--				PECHAN_CONFIG["]]..type..[["].reversal_moves = getCurrentReversalMoves("]]..type..[[")
	--			end]],
...
--					func = [[function()
--						-- Function for "(-) delay"				
	--					if PECHAN_CONFIG.REVERSAL_MOVES.MOVELIST:getReversal("]]..index..[[").on_guard_delay  == 0 then
	--						return
	--					end
	--					PECHAN_CONFIG.REVERSAL_MOVES.MOVELIST:getReversal("]]..index..[[").on_guard_delay   = PECHAN_CONFIG.REVERSAL_MOVES.MOVELIST:getReversal("]]..index..[[").on_guard_delay  - 1
	--				end]],
--				}
--				addElementToarray(arraindex)
	--			-- Third Element: "delay"
--				reversalmoveactivesettings[arraindex] = {
--					text = [[tostring(PECHAN_CONFIG.REVERSAL_MOVES.MOVELIST:getReversal("]]..index..[[").on_guard_delay)]],
...
--					olcolour = "black",
	...
	--				end]],
	--				autofunc = [[function(this)
	--					this.text = tostring(PECHAN_CONFIG.REVERSAL_MOVES.MOVELIST:getReversal("]]..index..[[").on_guard_delay )
	--				end]],
	--		
--				}
	--			addElementToarray(arraindex)
...
--					func =  [[function()
--						-- Function for "(-) times"				
	--					if PECHAN_CONFIG.REVERSAL_MOVES.MOVELIST:getReversal("]]..index..[[").on_guard_times == 1 then
--							return
--						end
--						PECHAN_CONFIG.REVERSAL_MOVES.MOVELIST:getReversal("]]..index..[[").on_guard_times  = PECHAN_CONFIG.REVERSAL_MOVES.MOVELIST:getReversal("]]..index..[[").on_guard_times - 1
--					end]],
--				}
--				addElementToarray(arraindex)
	--			-- sixth Element: "times"
	--			reversalmoveactivesettings[arraindex] = {
	--				text = [[tostring(PECHAN_CONFIG.REVERSAL_MOVES.MOVELIST:getReversal("]]..index..[[").on_guard_times)]],
	...
	--				end]],
	--				autofunc =[[function(this)
	--					this.text = tostring(PECHAN_CONFIG.REVERSAL_MOVES.MOVELIST:getReversal("]]..index..[[").on_guard_times)
	--				end]],
	--			}
	--			addElementToarray(arraindex)
...
initializeReversalMoveSettings(normal_moves, PECHAN_CONFIG,guipages.guard_reversal_move_active_settings , reversal_types.WAKEUP, true) ]]
--initializeReversalMoveSettings(normal_moves, PECHAN_CONFIG,guipages.wakeup_reversal_move_active_settings , reversal_types.WAKEUP, true)
...
initializeReversalMoveSettings(command_normals_moves, PECHAN_CONFIG,guipages[command_normals_page_name], reversal_types.GUARD)
initializeReversalMoveSettings(command_normals_moves, PECHAN_CONFIG,guipages[command_normals_page_name], reversal_types.WAKEUP) ]]
--- add special moves
...
initializeReversalMoveSettings(special_moves, PECHAN_CONFIG,guipages[specials_page_name], reversal_types.GUARD)
initializeReversalMoveSettings(special_moves, PECHAN_CONFIG,guipages[specials_page_name], reversal_types.WAKEUP) ]]
