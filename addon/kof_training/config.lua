KOF_CONFIG = {
    GAMES = {
        ...
        ["kof99"] = {
            ...
            offsets = {
                ...
                striker1_stored_index = 0x0000, -- Placeholder, pending user input
                striker2_stored_index = 0x0000, -- Placeholder, pending user input
                obj_ptr_list = 0x10B094 + 0xE90,
                game_phase = 0x10B094,
                level_address = 0x10FD8E,
                stage_address = 0x10A7EA,
    ...
    UI = {
        ...
        CURRENT_PLAYER1 = {},
        CURRENT_PLAYER2 = {},
        CURRENT_STRIKER1 = nil,
        CURRENT_STRIKER2 = nil,
        PLAYER1_EX = false,
        PLAYER2_EX = false,
