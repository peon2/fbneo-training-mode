...
guicustompage = {
	...
	----}
	{
			...
			olcolour = "black",
			handle = 8,
			func = 	function() changePageAndSelection("advancedsettings", 1) end,
	}
}
...
local reversalsettings = {
	...
	},
	{
		...
		olcolour = "black",
		info = "Back",
		func =  function() changePageAndSelection(interactivegui.previouspage,1) end,
	},
}
...
customPageConfiguration = { -- Two different buttons depending on whether the game has been patched or not
	...
	},
	{
			...
			func = 	function() changePageAndSelection("reversalsettings", 1) end, -- "reversalsettings" has been placed in "fbneo-training-mode/guipages.lua(l.588)", maybe there's a way to place it in this file ?
	}
}
-----------------------------------------------------------------------------------
-----------------------------------------------------------------------------------
...
character_specific_settings = {
	throw_projectiles =
	{
			...
			func = 	function() changePageAndSelection("specificsettings", 1) end, -- "specifcsettings" has been placed in "fbneo-training-mode/guipages.lua(l.588)", maybe there's a way to place it in this file ?
	},
